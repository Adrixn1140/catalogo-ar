...
1. Sube la carpeta `catalogo-ar` a un repositorio de GitHub.
2. En *Settings → Pages*, elige la rama y la carpeta `/ (root)`.
3. La URL será algo así como:
   `https://TU-USUARIO.github.io/catalogo-ar/index.html`
...
```
BASE_URL="https://TU-USUARIO.github.io/catalogo-ar/index.html" \
  python3 herramientas/generar_cartas.py
```
